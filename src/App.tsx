...
function VoiceSettings({ pack, error }: { pack: VoicePack | null; error: string }) {
  ...
  return <div className="settings-card voice-settings"><h2>Open-source Gulf voice</h2>
    <p>Lahja uses one fixed synthetic Saudi/Khaleeji speaker generated by an Apache-2.0 model. Your phone's Emirati/UAE Arabic voice is preferred as a temporary fallback for a newly added phrase that is not in the pack yet.</p>
